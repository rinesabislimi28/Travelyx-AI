...
export default function CookiePolicy() {
  return (
    <LegalPageLayout title="Cookie Policy" lastUpdated="April 2026" active="cookies">
      ...
      <section>
        <h2 className="mb-3 text-xl font-bold text-[var(--foreground)]">1. What Cookies Are</h2>
        <p>
      ...
      <section>
        <h2 className="mb-3 text-xl font-bold text-[var(--foreground)]">2. How We Use Cookies</h2>
        <p>
      ...
      <section>
        <h2 className="mb-3 text-xl font-bold text-[var(--foreground)]">3. The Cookies We Set</h2>
      ...
      <section>
        <h2 className="mb-3 text-xl font-bold text-[var(--foreground)]">4. Disabling Cookies</h2>
        <p>
